...
public class DocumentsAndResources extends BaseTest {
	...
	@Test(priority = 1,dependsOnMethods="loginProvider", description = "9.1 PROV-TECH-REQ-045 - Documents and Resources - Verify Create a lightning page to display document information")
